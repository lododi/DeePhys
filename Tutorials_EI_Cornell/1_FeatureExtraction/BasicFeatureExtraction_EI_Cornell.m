...
root_path = "/net/bs-filesvr02/export/group/hierlemann/intermediate_data/Maxtwo/lododi2/EI/"; % INSERT YOUR OWN PATH HERE
path_logic = {'2508*','*0*','AxonTracking','0*','d*','w*','sorter_output','qc_output'}; 
...
path_logic = {'250*','*0*','Network','0*','d*','w*','sorter_output','qc_output'}; 
...
metadata.LookupPath = "/links/groups/hierlemann/Projects/lododi/EI_AdvancedSciences_Philipp/Recordings/DeePhys_EI_250722.xlsx"; % INSERT YOUR OWN PATH HERE
...
path_parts = strsplit("/net/bs-filesvr02/export/group/hierlemann/intermediate_data/Maxtwo/lododi2/EI/250828/T003062/AxonTracking/000013/data.raw.h5/well001/sorter_output",'/')
...
metadata.PathPartIndex = [11,12,16];%insert indices you chose above [recording_date, plate_id, well_id]
metadata.min_N_units = params.QC.N_Units; %Minimum number of spike-sorted units to per form feature extraction
