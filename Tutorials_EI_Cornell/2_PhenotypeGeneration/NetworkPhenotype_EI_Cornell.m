...
path_logic = {'2508*','*0*','Network','0*','d*','w*','sorter_output','qc_output'}; 
...
rg_params.Selection.Exclusion = {{"DIV",14}}; %Cell array of cell arrays with fieldname + value
...
cluster_var = ["E_IRatio"]; % Can also be a list of several metadata vars

nodeSz = 20; % Scatter point size
mapSz = 500; % Size of the plot
sigma = 10; % Spread of the background coloring
cmap = othercolor('cbrewer',6); % Adjust for the number of conditions you want to plot simultaneously
