...
%root_path = "/net/bs-filesvr02/export/group/hierlemann/intermediate_data/Maxtwo/phornauer/Torsten_2/241016"; % INSERT YOUR OWN PATH HERE
%path_logic = {'T002*','Network','w*','sorter_output'}; %Variable parts
root_path = "/links/groups/hierlemann/Projects/ADHD/AnalyzedData/datastore/.cache"; % INSERT YOUR OWN PATH HERE
path_logic = {'*','data','w*','KS*','*'}; %Variable partswell_1/KS-2-250820-1149-70000121
...
% results!
unit_threshold = 30; % Minimum number of units
...
cmap = othercolor('Set16',20); % Adjust for the number of conditions you want to plot simultaneously

% Alternative colormap
red_color = [1, 0, 0];
orange_color = [1, 0.5, 0];
light_blue_color = [0.5, 0.8, 1];
blue_color = [0, 0, 1];

cmap = [red_color; orange_color; light_blue_color; blue_color];
...
pooling_vals = {{{"MR010C3","MR014C12"},{"KO015C1","KO013C39"}}};
...
% You can also find the results in the clf_rg object under Classification. 
