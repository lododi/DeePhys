...
root_path = "/net/bs-filesvr02/export/group/hierlemann/intermediate_data/Maxtwo/mpascual/Dup15/spikesorting"; % INSERT YOUR OWN PATH HERE
path_logic = {'T00*','250*','w*','sorter_output','qc_output'}; 
...
path_logic = {'T00*','2*','w*','sorter_output','qc_output'}; 
...
metadata.LookupPath = "/links/groups/hierlemann/Projects/lododi/EI_AdvancedSciences_Philipp/Recordings/DeePhys_EI_Maria_Metadata.xlsx"; % INSERT YOUR OWN PATH HERE
...
path_parts = strsplit("/net/bs-filesvr02/export/group/hierlemann/intermediate_data/Maxtwo/mpascual/Dup15/spikesorting/T003104/250603/well021/sorter_output",'/')
...
metadata.PathPartIndex = [13, 12, 14]; %insert indices you chose above [recording_date, plate_id, well_id]
