...
filepath = "/net/bs-filesvr02/export/group/hierlemann/intermediate_data/Mea1k/tgaenswein/QCedPathsSpikeSorted.mat";
sorting_path_list = load(filepath).sorting_path_list;
% The idea of this function is to find all folders that contain spike sorting
% output from a specified 'root_path'.
%root_path = "/links/groups/hierlemann/Projects/EI_class/AnalyzedData"; % INSERT YOUR OWN PATH HERE
...
check_failed_analysis(root_path, metadata, params);
