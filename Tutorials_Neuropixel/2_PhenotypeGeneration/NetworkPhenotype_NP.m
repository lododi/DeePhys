...
rg_params.Selection.Inclusion = {}; %Cell array of cell arrays with fieldname + value // empty defaults to including all recordings #{'DIV',14},{'RecordingDate',"240610"}
...
% WaveMAP algorithm.
unit_features = ["ReferenceWaveform"]; %"ReferenceWaveform","WaveformFeatures","ActivityFeatures","RegularityFeatures","GraphFeatures","Catch22" or "all"
...
cluster_var = ["Rat"]; % Can also be a list of several metadata vars

nodeSz = 20; % Scatter point size
mapSz = 500; % Size of the plot
sigma = 10; % Spread of the background coloring
cmap = othercolor('Set16',15); % Adjust for the number of conditions you want to plot simultaneously
