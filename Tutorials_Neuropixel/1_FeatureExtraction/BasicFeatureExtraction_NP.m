...
%% Find relevant EI MEArecording objects
...
root_path = "/links/groups/hierlemann/Projects/lododi/EI_AdvancedSciences_Philipp/Neuropixel_Dataset"; % INSERT YOUR OWN PATH HERE
...
path_logic = {'phy_output','25*','T*','we*','pynwb','*'}; 
...
params.Analyses.Connectivity    = ["FullCCG"]; % Takes a LONG time if you have a lot of units
...
metadata.LookupPath = "/links/groups/hierlemann/Projects/lododi/EI_AdvancedSciences_Philipp/Recordings/DeePhys_EI_Neuropixel.xlsx"; % INSERT YOUR OWN PATH HERE
...
path_parts = strsplit("/net/bs-filesvr02/export/group/hierlemann/intermediate_data/Maxtwo/lododi2/Neuropixel_Dataset/251121/T01001/well000",'/')
...
metadata.PathPartIndex = [11,12,13];%insert indices you chose above [recording_date, plate_id, well_id]
